class eskrim{
    private String kode_eskrim, rasa_eskrim, topping_eskrim;
    private int stok_eskrim, harga_eskrim; //Class es krim menjadi private yang kemudian dipanggil menggunakan fungsi get
    ...
    public void setStok(int stok_eskrim2){
        this.stok_eskrim = stok_eskrim2;
    }

    public void setHarga(int harga_eskrim2){
